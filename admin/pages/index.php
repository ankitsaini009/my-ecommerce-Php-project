...
if(isset($_GET['keyword']) && !empty($_GET['keyword'])){
  $addsearch .= ' && pages.title Like "%'.trim($_GET['keyword']).'%"';
}
if(isset($_GET['status']) && !empty($_GET['status'])){

  $addsearch .= ' && pages.status = "'.$_GET['status'].'"';
}
$countrecord = $conn->query("SELECT * FROM `pages` WHERE dstatus=0".$addsearch);
...
$getdata = $conn->query("SELECT * FROM `pages` WHERE dstatus=0".$addsearch." LIMIT ".$offset.",".$no_of_records_per_page);
              ...
              <div class="card-header">
                <div class="row">
                  ...
                  <div class="col-md-4 text-right">
                      <a href="<?php echo SITEADMIN;?>pages/aad.php" class="btn btn-success ">Add More</a>
                  </div>
                </div>
              </div>
              <!-- /.card-header -->
                ...
                <table class="table table-bordered">
                  ...
                  <tbody>
                    ...
                    <tr>
                      ...
                      <td><img src="<?php echo SITEURL.'uploads/banners/'.$data['banner']; ?>" width="70"></td>
                      <td><?php echo $data['status']==1?'<span class="badge bg-success">Active</span>':'<span class="badge bg-danger">Inactive</span>'; ?></td>
                      <td style="width: 150px;">
                        <a href="<?php echo SITEADMIN ;?>pages/edit.php?id=<?php echo $data['id'] ?>" class="btn-sm btn-success">Edit</a>
                        <a href="javascript:void(0);" onclick="detleterecord('Are You Delete This page','<?php echo SITEADMIN;?>pages/delete.php?id=<?php echo $data['id'] ?>')" class="btn-sm btn-danger">Delete</a>
