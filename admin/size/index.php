...
$countrecord = $conn->query("SELECT * FROM `size` WHERE dstatus=0".$addsearch);
...
$getdata = $conn->query("SELECT * FROM `size` WHERE dstatus=0".$addsearch." LIMIT ".$offset.",".$no_of_records_per_page);
              ...
              <div class="card-header">
                <div class="row">
                  ...
                  <div class="col-md-4 text-right">
                      <a href="<?php echo SITEADMIN;?>size/add.php" class="btn btn-success ">Add More</a>
                  </div>
                </div>
              </div>
              <!-- /.card-header -->
                ...
                <table class="table table-bordered">
                  ...
                  <tbody>
                    ...
                    <tr>
                      ...
                      <a href="<?php echo SITEADMIN ;?>size/edit.php?id=<?php echo $data['size_id'] ?>" class="btn-sm btn-success">Edit</a>
                        <a href="javascript:void(0);" onclick="detleterecord('Are You Delete This Brand','<?php echo SITEADMIN;?>size/delete.php?id=<?php echo $data['size_id'] ?>')" class="btn-sm btn-danger">Delete</a>
                      </td>
                    </tr>
                    <?php } ?>
